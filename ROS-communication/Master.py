...
class master():
    ...
    def ros_order_at_shelf_callback(self, data):
        ...
        ordered_shelves_dict = str(data.data)
        ordered_shelves_dict = ast.literal_eval(ordered_shelves_dict)
    ...
    def get_available_robots_for_order(self):
        ...
        for robot_id in self.ros_robots_movement_status_dict.keys():
            if self.ros_robots_movement_status_dict[robot_id] == 'waiting for order':
